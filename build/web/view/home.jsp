...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/style/css/style.css?v=2.8   "/>
        ...
        <header class="header-container p-3 pb-4 text-dark">
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <ul class="nav col-12 col-lg-9 me-lg-auto mb-2  mb-md-0">
                    ...
                    <div class="text-end col-lg-3 d-flex flex-wrap align-items-center justify-content-center">
                        <a href="${requestScope.login_href}" class="btn btn-dark me-2 text-light mr-3">${requestScope.login_href_value}</a>
